...
const Search = () => {
    ...
    const handleEnter = (e: React.KeyboardEvent<HTMLInputElement>) => {
        if(e.key === 'Enter'){
            returnSearch(e.currentTarget.value);
        }
    }

    const returnSearch = (search:string) => {
    ...
    return (
        <div>
            <div className="inputBox_container">
                ...
                <input className="inputBox" id="inputBox" type="text" placeholder="Search For Products"   onKeyDown={handleEnter}/>
            </div>
        </div>
    );
};
